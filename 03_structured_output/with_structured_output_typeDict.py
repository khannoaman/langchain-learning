...
class ReviewSummary(TypedDict):
    ...
    name_of_reviewer: Annotated[Optional[str], "Name of the reviewer (who reviewed) if mentioned in the review"]
    ratings: Annotated[Optional[float], "Rating given by the reviewer if mentioned in the review"]
